          ...
          <Container>
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h1 className="font-serif text-5xl md:text-6xl font-bold tracking-tight text-neutral-900 mb-6">
                Turn last night into{' '}
                <span className="italic text-[#D97757]">tonight.</span>
              </h1>
              ...
              <p className="mt-4 text-sm text-neutral-500">
                Leftovers AI is a Plus feature.{' '}
                <Link href="/pricing" className="text-[#D97757] hover:underline">Compare plans →</Link>
              </p>
            </div>
          </Container>
        </section>
