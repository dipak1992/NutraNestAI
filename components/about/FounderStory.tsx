      ...
      <Container>
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-7 space-y-8 text-lg leading-relaxed text-neutral-700 dark:text-neutral-300">
            ...
            <FadeIn delay={0.05}>
              <p>
                We&apos;re married. We live in a house that, most evenings,
                smells like something good is happening — and sometimes like
                something we forgot about. We have two little ones: a
                3½-year-old with strong opinions about what{' '}
                <em>isn&apos;t</em> dinner, and a 1-year-old who&apos;d happily
                eat the same banana three times a day.
              </p>
            </FadeIn>
            ...
            <FadeIn delay={0.1}>
              <p>
                ...
                groceries crept past $1,200 a month, she noticed first. We were
                both exhausted, both good at our jobs, and somehow still
            ...
            <FadeIn delay={0.2}>
              ...
              <p className="mt-4">
                ...
                Thursday. None of them knew we had a toddler who&apos;d riot
                over mushrooms.
              </p>
            </FadeIn>
            ...
            <FadeIn delay={0.25}>
              ...
              <p className="mt-4">
                ...
                correctly — when a &ldquo;recipe suggestion&rdquo; was
                something no real parent would ever cook on a Tuesday night.
              </p>
              <p className="mt-4">
            ...
            <FadeIn delay={0.3}>
              ...
              <p className="mt-4">
                MealEase isn&apos;t about becoming a better cook. It&apos;s not
                about optimizing macros or chasing some Pinterest dinner
