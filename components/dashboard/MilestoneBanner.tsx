...
const MILESTONES: Milestone[] = [
  ...
  },
  {
    ...
    description: 'You have enough favorites for a full weekly plan. Pro unlocks all 7 days + grocery list.',
  ...
  },
  {
    ...
    description: 'After 10+ meals explored, your recommendations are dialed in. Pro unlocks the full experience.',
    cta: 'Unlock Pro',
    href: '/pricing',
