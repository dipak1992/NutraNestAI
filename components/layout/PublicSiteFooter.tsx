  ...
  return (
    <footer className="border-t border-border/60 bg-muted/20 py-10">
      <div className="mx-auto flex max-w-6xl flex-col gap-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col gap-3 border-t border-border/60 pt-5 text-xs text-muted-foreground">
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <p>&copy; {new Date().getFullYear()} MealEase. Dinner that knows your family.</p>
            <p>Built by real parents for real family routines.</p>
          </div>
          <p className="max-w-3xl leading-relaxed">
            MealEase is a meal planning assistant — not a substitute for a medical professional. Always consult your healthcare provider for specific dietary guidance.
          </p>
        </div>
      </div>
    </footer>
